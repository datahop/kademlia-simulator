...
public class Clustering extends GraphObserver {
  ...
  /**
   * Prints information about the clustering coefficient. It uses {@value #PAR_N} nodes to collect
   * statistics. The output is produced by {@link IncrementalStats#toString}, over the values of the
   * clustering coefficients of the given number of nodes. Clustering coefficients are calculated by
   * {@link GraphAlgorithms#clustering}.
   *
   * @return always false
   */
