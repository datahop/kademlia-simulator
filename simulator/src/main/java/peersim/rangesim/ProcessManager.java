...
/**
 * This thread is used to kill forked processes in the case of an abnormal termination of the Java
 * virtual machine (for example, due to a signal).
 */
public class ProcessManager extends Thread {
  ...
  public void run() {
    ...
    for (int i = 0; i < threads.size(); i++) {
      if (threads.get(i) != null) threads.get(i).doStop();
    }
  }
}
