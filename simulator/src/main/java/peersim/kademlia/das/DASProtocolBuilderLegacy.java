...
// block.
public class DASProtocolBuilderLegacy extends DASProtocol {

  protected static String prefix = null;

  public DASProtocolBuilderLegacy(String prefix) {
    super(prefix);
    DASProtocolBuilderLegacy.prefix = prefix;
    isBuilder = true;
    isValidator = false;
  }
   ...
   */
  public Object clone() {
    DASProtocolBuilderLegacy dolly = new DASProtocolBuilderLegacy(DASProtocolBuilderLegacy.prefix);
    return dolly;
  }
}
