...
/**
 * Takes a {@link Linkable} protocol and adds connections following the small-world model of Watts
 * and Strogatz. Note that no connections are removed, they are only added. So it can be used in
...
public class WireWS extends WireGraph {
  ...
  /**
   * The beta parameter of a Watts-Strogatz graph represents the probability for a node to be
   * re-wired. Passed to {@link GraphFactory#wireWS}.
   *
   * @config
   */
  ...
  /**
   * The degree of the graph. See {@link GraphFactory#wireRingLattice}. Passed to {@link
   * GraphFactory#wireWS}.
   *
   * @config
   */
