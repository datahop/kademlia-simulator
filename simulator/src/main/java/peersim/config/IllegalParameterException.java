...
/**
 * Exception thrown to indicate that a configuration property has an invalid value. It is thrown by
 * several methods in {@link Configuration} and can be thrown by any component that reads the
 * configuration.
 */
public class IllegalParameterException extends RuntimeException {
  ...
  /**
   * Calls super constructor. It passes a string message which is the given message, prefixed with
  ...
  /**
   * Extends message with info from stack trace. It tries to guess what class called {@link
   * Configuration} and adds relevant info from the stack trace about it to the message.
   */
