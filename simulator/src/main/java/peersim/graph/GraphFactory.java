...
/**
 * Contains static methods for wiring certain kinds of graphs. The general contract of all methods
 * is that they accept any graph and add edges as specified in the documentation.
 */
