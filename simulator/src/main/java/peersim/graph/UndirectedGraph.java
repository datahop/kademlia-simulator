 ...
 * The graph to be made undirected is passed to the constructor. Only the reference is stored so if
 * the directed graph changes later, the undirected version will follow that change. However, {@link
 * #getNeighbours} has O(n) time complexity (in other words, too slow for large graphs).
 *
 * @see ConstUndirGraph
 */
