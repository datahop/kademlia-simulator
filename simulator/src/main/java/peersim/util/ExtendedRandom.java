...
public class ExtendedRandom extends Random {
  ...
  /** Calls super constructor. Also stores the seed to be returned by {@link #getLastSeed}. */
   ...
   * @return a pseudorandom, uniformly distributed long value between 0 (inclusive) and n
   *     (exclusive).
   */
  ...
  /**
   * Sets random seed. Calls super method but also stores the seed to be returned by {@link
   * #getLastSeed}.
   */
  ...
  /**
   * Returns the last random seed that was set explicitly. Either at construction time or through
   * {@link #setSeed}.
   */
