...
/**
 * This class adds the ability to retrieve the median element to the {@link IncrementalStats} class.
 * Note that this class actually stores all the elements, so (unlike in its superclass) storage
 * requirements depend on the number of items processed.
 *
 * @author giampa
 */
