...
public class FileNameGenerator {
  ...
  /**
   * Generates a name based on a counter. The format of the name returned is {@link #prefix}
   * followed by an 8 digit zero padded number, followed by {@link #ext}. The first number used is
   * zero.
   *
